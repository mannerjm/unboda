...
assert(aiClient.includes("질문권 구매하기 →") && aiClient.includes("질문권 상품 안내 보기 →") && aiClient.includes("creditCheckoutAvailable"), "AI hub must expose a prominent credit purchase path only when checkout is available for the active user");
