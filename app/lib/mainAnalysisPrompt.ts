...
export function buildMainAnalysisPrompt(
  ...
  return [
    ...
    "출력은 반드시 아래 순서와 구조로 구성하세요: 1) 한눈에 보는 핵심 2) 원국 결과와 신강·신약의 맥락 3) 용신 해석 4) 격국 해석 5) 현재 대운과 세운 해석 6) 직업과 일 7) 재물운 8) 인간관계 9) 건강과 생활 리듬 10) 종합/마무리.",
    ...
    "- 현재 대운과 세운 해석: 원국의 구조와 용신·격국의 관계 속에서 현재 대운·세운이 어떻게 작동하는지 설명한다. 독립된 정보 나열이 아니라 관계 해석 중심으로 쓴다.",
    "- 직업과 일: 명리 근거를 최소 1~2개 연결해서 설명하고, 그다음 현실 경향을 적는다. 너무 길게 늘리지 말고 후반 섹션과 균형을 맞춘다.",
    "- 재물운: 직업과 일과 같은 맥락을 이어받되, 재물과 자산 흐름에 필요한 명리 근거를 1~2개 연결해서 설명한다.",
    "- 인간관계: 관계의 형성·갈등·소통 방식이 어떤 명리 근거에서 나오는지 최소 1~2개의 근거로 설명한다.",
    "- 건강과 생활 리듬: 건강과 휴식, 생활 패턴의 변화가 어떤 명리 구조에서 나타나는지 연결해 설명한다.",
