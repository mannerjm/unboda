...
assert(answerPipeline.includes("질문을 반복해서 쓰거나") && answerPipeline.includes("작은 행동 최대 2개"), "replies must avoid repeating customer questions and provide only a short actionable follow-up");
