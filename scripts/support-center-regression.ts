...
assert.match(migration, /char_length\(message\) between 20 and 1200/);
...
assert.match(server, /MESSAGE_MIN_LENGTH = 20/);
assert.match(server, /MESSAGE_MAX_LENGTH = 1200/);
assert.match(server, /normalized\.length < MESSAGE_MIN_LENGTH/);
assert.match(server, /normalized\.length > MESSAGE_MAX_LENGTH/);
