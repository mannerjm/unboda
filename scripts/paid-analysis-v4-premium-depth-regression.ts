...
assert(launchProductIds.length === 32, "Batch 3 launch set must contain exactly 32 products");
...
assert(topicContracts.length === 31, "31 Batch 3 launch entries must be TopicConfigs");
assert(
