...
assert(launchProductIds.length === 22, "Batch 1 launch set must contain exactly 22 products");
...
assert(topicContracts.length === 21, "21 Batch 1 launch entries must be TopicConfigs");
assert(
