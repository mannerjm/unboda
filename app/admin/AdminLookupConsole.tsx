...
export default function AdminLookupConsole({
  ...
  return (
    <section className="mt-8" aria-labelledby="cs-console-heading">
      <header className="border-b border-stone-200 pb-6"><p className="text-xs font-semibold tracking-[0.2em] text-stone-500">CS CONSOLE</p><h2 id="cs-console-heading" className="mt-3 text-2xl font-bold">고객 지원 조회</h2><p className="mt-3 text-sm leading-6 text-stone-600">고객 지원 목적의 조회 전용 화면입니다. 조회 결과를 임의로 변경하지 마세요.</p></header>
