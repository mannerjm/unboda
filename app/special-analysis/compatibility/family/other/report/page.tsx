...
import { COMPATIBILITY_FAMILY_OTHER_PRODUCT_ID } from "@/app/lib/specialAnalysisProducts";
...
export default async function FamilyOtherPurchasedReportPage({ searchParams }: Props) {
  ...
  const entitlements = (await listUserEntitlements(user.id))
    .filter((item) => item.profileId === profileId
      && item.resourceId === COMPATIBILITY_FAMILY_OTHER_PRODUCT_ID
