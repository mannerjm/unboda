...
- 본문에서는 오행 비율(예: 33%, 9.6%)을 직접 표기하지 마세요.
- 오행 비율은 '한눈에 보는 핵심'에서만 사용하세요.
- 성격, 직업, 인간관계, 재물 등의 본문은 퍼센트 대신 실제 사람의 성향과 행동으로 설명하세요.
- "수가 강합니다", "금이 약합니다"처럼 끝내지 말고, 그것이 실제 생활에서 어떻게 나타나는지 설명하세요.
