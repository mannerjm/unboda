...
export const ANALYSIS_TOPICS: AnalysisTopicDefinition[] = [
    ...
    ],  },
  {
    ...
    shortDescription: "지출·계약·공동 부담에서 손실 노출이 커지는 구조와 위험 감소 기준을 분석합니다.",
    riskLevel: "sensitive",
    details: [
      "지출·계약·공동 부담에서 손실 노출이 반복되는 구조",
      "경쟁·공동 부담·고정비에서 통제 가능한 범위가 약해지는 조건",
      "충동 지출·손실 만회성 판단·계약 조건 누락처럼 미리 확인할 위험 신호",
      "손실을 확대하는 판단과 반응을 멈추고 재검토하는 기준",
      "현금 흐름 압박과 고정비 부담이 커질 때 점검할 현실적 조건",
      "지출·계약·공동 부담에서 위험을 줄이기 위해 조정할 행동",
    ],
  },
  {
  ...
  },
  {
    ...
    category: "money",
    title: "저축과 자산 관리 습관",
    shortDescription: "저축·예산 기준을 유지하고 반복 가능한 관리 루틴을 재설정하는 방법을 분석합니다.",
    riskLevel: "sensitive",
    details: [
      "월·주 단위 저축·예산 기준이 유지되거나 무너지는 반복 조건",
      "변동지출에서 정한 한도와 실제 사용이 어긋나는 관찰 신호",
      "자동 이체·정기 점검·잔액 확인을 지속 가능한 관리 순서로 만드는 기준",
      "기록과 검토가 끊기기 쉬운 생활 조건과 다시 시작할 신호",
      "저축·예산 기준이 깨진 뒤 다음 주기에서 한도와 규칙을 재설정하는 방법",
      "정기 자산관리를 무리 없이 이어가기 위해 확인할 유지 기준",
    ],
  },
  {
  ...
  },
  {
    ...
    shortDescription: "새로운 관계의 접점·초기 상호작용·초기 신뢰 진입 조건을 분석합니다.",
    riskLevel: "standard",
    details: [
      "새로운 접점이 자연스럽게 이어지는 활동·환경·상호작용 조건",
      "첫 연락·만남·공동 활동에서 접근이 이어지거나 멈추는 초기 반응",
      "초기 신뢰 진입 전에 확인할 응답·약속·관심 표현의 일관성 신호",
      "새로운 상호작용이 실제 관계 탐색으로 이어질지 검토하는 기준",
      "정확한 사람·날짜·장소 예측 없이 접점과 접근 방식을 재검토하는 방법",
      "초기 탐색에서 무리한 확신·과잉 대응을 피하기 위해 관찰할 조건",
    ],
  },
  {
    ...
    category: "relationship",
    title: "결혼·장기 관계 흐름",
    shortDescription: "장기 결합을 준비할 때 함께 살아가기 위한 생활·역할·책임 조건과 조정 기준을 분석합니다.",
    riskLevel: "standard",
    details: [
      "장기 결합 후 함께 살아갈 때 안정성을 좌우하는 생활 조건",
      "역할·책임·재정·가족 관련 기대를 조율하는 기준",
      "생활 리듬과 갈등 대응에서 미리 확인할 현실적인 마찰 신호",
      "공동생활을 준비하기 전에 합의가 필요한 항목과 점검 순서",
      "한쪽 부담이 커지거나 조건이 맞지 않을 때 조정할 기준",
      "결합을 서두르기보다 생활·책임 조건을 다시 확인해야 하는 신호",
    ],
  },
  {
    ...
    category: "relationship",
    title: "배우자·파트너 패턴",
    shortDescription: "반복해서 선택하는 상대 특성과 역할 기대를 살피고, 실제 적합성을 검증할 다음 선택 기준을 분석합니다.",
    riskLevel: "standard",
    details: [
      "과거 관계에서 반복해서 선택한 상대 특성과 끌림의 기준",
      "반복 선택한 관계 구조와 안정적 적합성을 혼동한 지점",
      "상대에게 기대하거나 사용자가 떠맡기 쉬운 역할과 책임",
      "강한 끌림과 말보다 반복된 실제 적합 신호를 구분하는 기준",
      "다음 관계에서 적용할 선택 기준과 검증 순서",
      "관계 초기에 확인할 책임·역할 분담 질문",
      "선택을 멈추고 다시 확인해야 하는 신호와 중단 기준",
    ],
  },
  {
    ...
    details: [
      ...
      "갈등 후 대화 재개·행동 변화·감정 소모처럼 회복 과정에서 확인할 신호",
      "충돌이 완화되거나 반복되는 조건과 회복 판단 기준",
      "수습과 재발 방지를 위해 취할 행동과 피해야 할 반응",
    ],
  },
  {
    ...
    riskLevel: "standard",
    details: [
      "과도한 허용과 개입이 관계 부담으로 바뀌는 명리적 구조",
      "연락·시간·개인 공간에서 경계가 무너지기 쉬운 조건",
      "역할 불균형·감정 노동 과부하처럼 확인할 현실 신호",
      "허용·거절 기준과 거리 조절을 위해 관찰할 기준",
      "관계 운영 기준을 조정하기 위해 취할 행동과 피해야 할 반응",
    ],
  },
  {
    ...
    category: "relationship",
    title: "재회 가능성과 판단 기준",
    shortDescription: "단절 이후 변화와 상호 재접점을 확인해 재연결 시도·보류 기준을 분석합니다.",
    riskLevel: "standard",
    details: [
      "단절에 이르게 된 상황과 이전 관계에서 반복된 문제를 구분하는 기준",
      "상호적인 재접점과 구체적인 대화 제안처럼 다시 연결을 검토할 신호",
      "말이나 감정 표현이 아닌 실제 행동 변화와 이전 문제 감소를 확인하는 방법",
      "재연결을 시도하거나 보류하기 전에 확인할 조건과 중단 기준",
      "단절을 만든 패턴이 반복될 때 피해야 할 반응",
    ],
  },
  {
    ...
    category: "relationship",
    title: "친밀감 형성 속도",
    shortDescription: "형성된 관계 안에서 친밀감의 속도와 감정 거리를 조절하는 기준을 분석합니다.",
    riskLevel: "standard",
    details: [
      "친밀감이 형성되는 속도와 방식의 명리적 배경",
      "감정 개방의 깊이와 관계 안정성을 구분하는 판단 기준",
      "현재 운에서 표현과 감정 거리에 영향을 주는 요인",
      "형성된 관계에서 친밀감 속도를 확인할 현실 신호",
