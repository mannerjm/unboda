...
assert(parentChildPage.includes("FamilyCompatibilityAnalysisClient") && parentChildPage.includes("가족 궁합 분석"), "family analysis route must mount the in-page relationship selector and analysis flow");
...
assert(familyAnalysisClient.includes('value: "parent_child"') && familyAnalysisClient.includes("FamilyParentChildAnalysisClient"), "parent-child must remain the available family relationship implementation");
