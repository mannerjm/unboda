...
function CompleteGuestAnalysisContent() {
  ...
  return <main className="flex min-h-screen items-center justify-center bg-[#f5f7fc] px-6 text-center text-stone-900"><section className="w-full max-w-lg rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
...
export default function CompleteGuestAnalysisPage() {
  return (
    <Suspense fallback={<main className="flex min-h-screen items-center justify-center bg-[#f5f7fc] px-6 text-center text-sm text-stone-700">분석 결과를 계정에 연결하고 있습니다...</main>}>
