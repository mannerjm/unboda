...
export function buildMainAnalysisPrompt(
  ...
  return [
    ...
    "'구조', '배치', '기운', '신호', '작용', '보완' 같은 추상적인 명리식 표현을 반복하지 마세요. '책임을 많이 떠안기 쉽다', '결정을 오래 고민하기 쉽다', '일과 돈 문제가 함께 부담이 될 수 있다'처럼 생활에서 바로 이해되는 말로 바꾸세요.",
    "특히 '상황의 영향을 많이 받는 구조', '현실적인 책임과 압박이 강하게 작용하는 배치', '부족한 균형을 보완하는 기운', '변화 신호와 충돌 신호', '구조적인 방향 전환' 같은 표현은 사용하지 마세요.",
    ...
    "- 한눈에 보는 핵심의 마지막 문장은 사용자가 가장 우선인 현재 문제에서 아직 확인되지 않은 핵심을 자연스럽게 궁금해하도록 끝내되, 답이나 해결책은 제시하지 않는다."
  ].join("\n");
}
