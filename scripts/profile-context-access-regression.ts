...
assert(checkoutPage.includes("searchParams") && checkoutPage.includes("currentProfileId={profileId}"), "checkout page must read and render profileId query context");
...
console.log("2. checkout requires and preserves selected profileId ✓");
...
console.log("3. paid access and report gate are profile-scoped ✓");
...
console.log("4. detail API verifies profile entitlement before OpenAI ✓");
...
console.log("5. account-wide paid-analysis entitlement fallback removed ✓");
