...
assert(launchProductIds.length === 27, "Batch 2 launch set must contain exactly 27 products");
...
assert(topicContracts.length === 26, "26 Batch 2 launch entries must be TopicConfigs");
assert(
