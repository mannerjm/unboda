    ...
    <form onSubmit={submit} className="mx-auto mt-8 max-w-3xl overflow-hidden rounded-[30px] border border-[#dfe3ef] bg-white shadow-[0_18px_50px_rgba(32,38,72,0.08)]">
      <div className="relative overflow-hidden bg-[linear-gradient(135deg,#f1f0ff_0%,#f9faff_58%,#f7f8ff_100%)] px-6 py-8 sm:px-8 sm:py-9">
        ...
        <div className="relative">
          ...
          <p className="mt-2 text-2xl font-bold tracking-[-0.02em] text-stone-950">
            {myProfileLabel}님의 사주 <span className="font-medium text-stone-400">×</span> 가족 사주
          </p>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-stone-600">
            먼저 이 관계에서 내가 부모인지 자녀인지 선택한 뒤 상대 가족의 정보를 입력해 주세요. 결제 시점의 연도판으로 생성되어 구매한 분석에 그대로 보관됩니다.
          </p>
          <div className="mt-5 flex flex-wrap gap-2">
            <span className="rounded-full border border-[#dfe3ef] bg-white/75 px-3 py-1.5 text-xs font-semibold text-stone-700">부모·자녀 관계</span>
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="mt-7 grid gap-5 sm:grid-cols-2">
          <label className="sm:col-span-2">
            ...
            <input
              ...
              maxLength={40}
              required
              className="mt-2 w-full rounded-2xl border border-stone-300 bg-white px-4 py-3.5 text-sm outline-none transition focus:border-stone-500 focus:ring-2 focus:ring-stone-100"
          ...
          <div>
            <label className="block">
              ...
              <input
                ...
                className="mt-2 w-full rounded-2xl border border-stone-300 bg-white px-4 py-3.5 text-sm outline-none transition disabled:bg-stone-100 disabled:text-stone-400 focus:border-stone-500"
              />
            </label>
        ...
        <div className="mt-7 overflow-hidden rounded-3xl border border-[#dfe3ef] bg-[linear-gradient(135deg,#f5f6fc_0%,#f9faff_100%)] shadow-sm">
          <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-end sm:justify-between sm:p-6">
            <div>
              ...
              <p className="mt-2 text-sm font-semibold text-stone-800">부모·자녀 관계 분석을 결제 후 바로 생성합니다.</p>
            ...
            <div className="shrink-0 sm:text-right">
              ...
              <p className="mt-1 text-[22px] font-bold tracking-[-0.02em] text-stone-950">{COMPATIBILITY_FAMILY_PARENT_CHILD_PRODUCT.amount.toLocaleString("ko-KR")}원</p>
            </div>
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={!canSubmit}
          className="mt-3 inline-flex w-full items-center justify-center rounded-2xl bg-stone-900 px-5 py-4 text-sm font-bold text-white transition hover:bg-stone-800 disabled:cursor-not-allowed disabled:bg-stone-300"
        >
          결제하고 궁합 분석하기
        </button>
