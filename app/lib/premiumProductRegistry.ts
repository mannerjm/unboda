...
export const PREMIUM_PRODUCT_REGISTRY = {
  relationship: {
    ...
    description:
      "여러 관계에서 반복되는 거리·갈등·반응 패턴과 관계 운영 기준을 분석합니다.",

    details: [
      "여러 관계에서 반복되는 거리·갈등·감정 소모 패턴",
      "관계 변화가 시작되는 촉발 조건과 반응 방식",
      "관계 유형별로 유지할 거리와 경계 기준",
      "갈등과 감정 소모를 줄이기 위해 확인할 행동 신호",
      "관계 운영 방식을 조정하기 위한 현실적인 검증 기준",
    ],
  ...
  wealth: {
    ...
    description:
      "현재 재물 운영을 수입, 유출, 활동·계약 조건과 위험 분산의 관점에서 심층적으로 분석합니다.",

    details: [
      "현재 재물 흐름이 나타나는 명리학적 이유",
      "수입 경로와 유출 구조의 균형",
      "활동·계약의 비용과 책임을 점검하는 기준",
      "현재 확대·유지·조정·보류 중 필요한 판단",
      "위험 분산과 재물 운영의 우선순위",
      "실제 생활에서 확인할 재물 운영 기준",
    ],
    ...
    recommendedFor: [
      ...
      "수입과 유출의 균형을 다시 점검하고 싶은 사람",
      "현재 활동과 계약의 비용 부담을 점검하고 싶은 사람",
    ],
    ...
    expectedOutcome: [
      ...
      "활동·계약의 비용과 책임을 판단하는 기준 확보",
      "위험 분산과 재물 운영의 관리 기준 확보",
    ],
},
    career: {
  id: "career",
