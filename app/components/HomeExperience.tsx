      ...
      <div className="mx-auto flex min-h-[calc(100vh-3.5rem)] w-full max-w-[1240px] flex-col gap-5 sm:gap-6">
        ...
        <section className="grid min-h-[470px] items-center gap-2 py-0 lg:grid-cols-[0.84fr_1.16fr] lg:gap-0 xl:gap-1">
          <div className="relative z-10 lg:pl-7">
            <p className="inline-flex rounded-full border border-[#dfcda9] bg-white/45 px-4 py-2 text-xs font-bold tracking-[0.18em] text-[#a47735]">나를 기억하는 AI 명리</p>
            <h1 className="mt-5 max-w-[31rem] font-serif text-[2.65rem] font-semibold leading-[1.12] tracking-[-0.045em] text-[#191817] sm:text-[3.35rem]">내 사주를 이해하고,<br />내 이야기를 <span className="text-[#b8893c]">기억하는</span><br />나만의 AI 운세</h1>
            <p className="mt-5 max-w-[31rem] text-[14px] leading-7 text-[#6f665a] sm:text-[15px]">한 번 보고 끝나는 풀이가 아닙니다. 사주 분석과 이전 상담,<br className="hidden sm:block" /> 내가 저장한 중요한 기억을 바탕으로 다음 상담도 자연스럽게 이어집니다.</p>
